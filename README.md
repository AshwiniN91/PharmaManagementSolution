...
* **Billing:** A dynamic **Billing Page** that automates invoice calculations.
* **PDF Export:** Generate and download official bill invoices directly as **PDF documents** on a button click.
* **Records Management:** 
  * **Medical Page:** Manage healthcare products, drug records, and stock details.
  * **Manufacturer Page:** Track drug manufacturers, and corporate details.
